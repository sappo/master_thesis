...
ausprobiert und ausgewertet. Zunächst werden die Parameter des Blocking Schema
...
Search, der Grid Search auf dem NCVoter Datensatz kleiner einer Stunde ist.
Dieser ist für die Evalution vertretbar, da dadruch stets die besten Parameter
gefunden werden.

Ein Qualitätsmaß muss sowohl Recall als auch Precision berücksichtigen, deshalb
wurden hierzu das F-measure und die Average Precision getestet. Testen morgen
F-measure vs Average precision

Kreuzvalidierung Testen morgen.
