...
* Soll ein Verfahren auf Daten einer Domäne angewendet werden, zu welcher keine
  ...
  sein sollen. Paare größer $ut$ werden dadurch als Matches und Paare kleiner
  $lt$ als Non-Matches klassifiziert. Der genaue Algorithmus wird in
  \ref{sec:weaklbl} beschrieben.
...
![Beispiele von Qualitätsgraphen aus [@Chr:Data:12]. **b**. Precision-Recall, **c**. F-measure, **d**. ROC Kurve. \TODO{Ersetzen durch eigene Graphen!} ](images/quality_graphs.png){#fig:quality_graphs}
