...
bildet und deren Ähnlichkeit berechnet. Anstatt mittels zweier Schwellen diese
in Matches und Non-Matches zu trennen, ist es bei vorhandener Ground Truth
möglich, die Matches aus der Menge zu entfernen, sodass lediglich Non-Matches
übrig bleiben. Da das Blocking der Paare, anhand von Token durchgeführt wurde,
sind zum einen wenig substantielle Paare, mit einer Ähnlichkeit nahe 0,
...
liegt dabei zwischen 0 und 1, wohingegen der Blockdurschnitt und die
Blockvarianz deutlich darüber liegen können. Daher ist es praktisch extrem
schwierig geeignete gewichte zu finden, um nicht ein Kriterum stark
überzugewichten.

## Dynamische Blocking Verfahren
