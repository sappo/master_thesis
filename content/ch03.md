...
ID & Entitäts-ID & Vorname & Zweitname & Nachname \\ \midrule
1  & 1           & Peter   & Moritz    & Michel   \\
2  & 1           & Moritz  & Peter     & Michel   \\
3  & 2           & Michel  & Moritz    & Peter    \\
4  & 2           & Michle  & Moritz    & Peter    \\ \bottomrule
\end{tabular}
\caption{Beispieldatensätze zur Veranschaulichung der Kommutativität bei der
...
Datensatz 1 und 2, sowie 3 und 4 die selbe Entität.}
\label{tbl:comm_examles}
\end{table}
```
